...
st.set_page_config(page_title='Extrator DIRF + Motor Previdenciário V1.2.14', page_icon='📄', layout='wide')
    ...
    if ap_base.empty:
        ...
        if ap_scope.empty:
            ...
            if result.empty:
                ...
                st.download_button('Baixar apuração CSV', csv_bytes(result), 'apuracao_previdenciaria_v1_2_14.csv', 'text/csv')
