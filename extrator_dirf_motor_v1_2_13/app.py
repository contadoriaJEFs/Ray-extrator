...
st.set_page_config(page_title='Extrator DIRF + Motor Previdenciário V1.2.12', page_icon='📄', layout='wide')
...
st.title('Extrator DIRF + Motor Previdenciário V1.2.12')
    ...
    if ap_base.empty:
        ...
        if ap_scope.empty:
            ...
            if result.empty:
                ...
                st.download_button('Baixar apuração CSV', csv_bytes(result), 'apuracao_previdenciaria_v1_2_11.csv', 'text/csv')
...
with tabs[5]:
    ...
    if not comps:
        ...
        for comp in comps:
            ...
            # Agrupamento horizontal é exclusivamente por identidade do declarante
            # (CNPJ canônico), independentemente da página/bloco em que os
            # lançamentos foram encontrados. Todas as ocorrências do mesmo CNPJ
            # na competência são somadas nas mesmas duas colunas.
