# Extrator DIRF + Motor Previdenciário — V1.2.20
...
## V1.2.13 — Apuração por competência
...
## V1.2.20
Deduplicação documental conservadora: declarações DIRF integralmente repetidas no mesmo PDF são marcadas no RAW e consideradas uma única vez nas etapas previdenciárias.
