...
st.set_page_config(page_title='Extrator DIRF + Motor Previdenciário V1.2.16', page_icon='📄', layout='wide')
    ...
    if ap_base.empty:
        ...
        if anos_13_opcoes:
            ...
            for ano in anos_13_opcoes:
                if c13a.checkbox(f'Incluir 13º/{ano}', value=False, key=f'apuracao_incluir_13_{ano}'):
        ...
        if ap_scope.empty:
            ...
            if result.empty:
                ...
                st.download_button('Baixar apuração CSV', csv_bytes(result), 'apuracao_previdenciaria_v1_2_18.csv', 'text/csv')
