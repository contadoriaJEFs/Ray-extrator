...
st.set_page_config(page_title='Extrator DIRF + Motor Previdenciário V1.2.27', page_icon='⚖️', layout='wide', initial_sidebar_state='expanded')
...
def gerar_relatorio_pdf(result_df=None, horiz_df=None, declarantes=None, periodo='—', decimos=None, dedup_stats=None):
    ...
    if result_df is not None and not result_df.empty:
        ...
        for _, r in result_df.iterrows():
            data.append([
                Paragraph(_pdf_text(r.get('Competência', '')), th_comp),
        ...
        story.append(_pdf_table(data, widths, 10.5, align_right_cols=list(range(2, 9))))
    ...
    if horiz_df is not None and not horiz_df.empty:
        ...
        for chunk_idx in range(0, len(pares), chunk_size):
            ...
            head1 = [Paragraph('COMPETÊNCIA', ParagraphStyle('JFTHCOMP2', parent=th_white, fontSize=10.5, leading=12, alignment=TA_CENTER))]
            head2 = [Paragraph('', th)]
